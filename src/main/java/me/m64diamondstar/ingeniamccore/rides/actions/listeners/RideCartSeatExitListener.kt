...
import me.m64diamondstar.ingeniamccore.rides.events.RideCartSeatExitEvent
import me.m64diamondstar.ingeniamccore.rides.expression.Expression
import org.bukkit.event.Event

class RideCartSeatExitListener(override val eventType: Class<out RideCartSeatExitEvent>) : RideListener {
    override fun getType(): String {
        return "seat_exit"
    }

    override fun onEventTriggered(ride: Ride, id: String, event: Event) {
        val rideEvent = event as RideCartSeatExitEvent
