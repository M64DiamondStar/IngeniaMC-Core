...
import me.m64diamondstar.ingeniamccore.rides.events.RideCartSeatEnterEvent
import me.m64diamondstar.ingeniamccore.rides.expression.Expression
import org.bukkit.event.Event

class RideCartSeatEnterListener(override val eventType: Class<out RideCartSeatEnterEvent>) : RideListener {
    override fun getType(): String {
        return "seat_enter"
    }

    override fun onEventTriggered(ride: Ride, id: String, event: Event) {
        val rideEvent = event as RideCartSeatEnterEvent
