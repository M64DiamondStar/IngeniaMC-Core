package me.m64diamondstar.ingeniamccore.shows
 ...
 */
class EffectShow(private val category: String, private val name: String, val players: List<Player>?): LoadedConfiguration("shows/$category", name, false, true) {
